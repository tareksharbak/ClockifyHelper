...
namespace ClockifyHelper
{
	public class ViewModel : ViewModelBase
	{
		...
		private readonly Action<bool> changeToggleActivationButtonText;
		...
		public ViewModel(ApplicationSettings applicationSettings, Action<string> showNotification, Action<bool> changeToggleActivationButtonText)
		{
			...
			this.changeToggleActivationButtonText = changeToggleActivationButtonText;
		}
		...
		public bool IsStarted
		{
			...
			set
			{
				...
				changeToggleActivationButtonText(value);
			}
		}
